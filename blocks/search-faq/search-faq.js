...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'search-faq-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'search-faq-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-faq-results');
...
function searchResultsContainer(block) {
  ...
  results.className = 'search-faq-results';
...
function searchInput(block, config) {
  ...
  input.className = 'search-faq-input';
...
function searchBox(block, config) {
  ...
  box.classList.add('search-faq-box');
  box.append(
    searchIcon(),
